...
\begin{document}
  ...
  \section{Introducción}\label{sec:intro}
    ...
    \subsection{Interacción de la radiación de partículas con la materia}\label{sec:intro:radiation}
      %TODO: Completar el GAP que hay acá
      ...
      e inteligencia artificial \cite{ROE2005577}.  % FIXME: No estoy muy seguro de que este sea el caso jajaja.
  ...
  \section{Resultados y discusión}\label{sec:results}
    ...
    \subsection{Medición de Rayos Cósmicos}\label{sec:results:cosmic_ray}
      Utilizando la librería se pudo encontrar $N$ %TODO: Cambiar poner el valor
      ...
      \begin{figure}[h]
        \includegraphics[width=0.47\textwidth]{figures/06-04-18_09-27-42.pdf} % TODO: Poner para que salga pixelada :(
